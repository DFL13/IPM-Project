...
function createPanZoom(domElement, options) {
  ...
  function keepTransformInsideBounds() {
    ...
    if (clientRect.right < boundingBox.right) {
      transform.x += boundingBox.right - clientRect.right
      adjusted = true
    }
    ...
    if (clientRect.bottom < boundingBox.bottom) {
      transform.y += boundingBox.bottom - clientRect.bottom
      adjusted = true
    }
  ...
  function zoomByRatio(clientX, clientY, ratio) {
    ...
    /*if (!transformAdjusted)*/ transform.scale *= ratio/*peekaboo I changed you*/
  ...
  function applyTransform() {
    isDirty = false
    keepTransformInsideBounds()/*peekaboo I changed you*/
